            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white dark:bg-slate-900 p-4 rounded-[6px]">
                    ...
                    <div className="mt-4 text-center flex gap-4 flex-wrap text-xs text-gray-700">
                        <Link className="flex-1 min-w-fit p-3 rounded-[6px] bg-pink-200" to={'/list/classes'}>Teacher's Classes</Link>
                        <Link className="flex-1 min-w-fit p-3 rounded-[6px] bg-emerald-200" to={'/list/students'}>Teacher's Students</Link>
                        <Link className="flex-1 min-w-fit p-3 rounded-[6px] bg-sky-200" to={'/list/lessons'}>Teacher's Lessons</Link>
                        <Link className="flex-1 min-w-fit p-3 rounded-[6px] bg-orange-200" to={'/list/exams'}>Teacher's Exams</Link>
                        <Link className="flex-1 min-w-fit p-3 rounded-[6px] bg-purple-200" to={'/list/assignments'}>Teacher's Assignments</Link>
                    </div>
                </div>
                {/* <Performance /> */}
                <Announcements />
