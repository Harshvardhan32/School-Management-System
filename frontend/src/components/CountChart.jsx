    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-[6px] w-full h-full p-4 shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
            ...
            <div className='relative flex items-center justify-between'>
                ...
                <Link to='/list/students' className="text-sm text-gray-400">View All</Link>
            </div>
            {/* CHART */}
            <div className="relative w-full h-[75%]">
                ...
                <img src="/maleFemale.png" alt="" className="absolute max-w-24 max-h-24 lg:max-w-20 lg:max-h-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
            </div>
            {/* BOTTOM */}
