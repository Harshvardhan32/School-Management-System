                                        ...
                                        return (
                                            (
                                                <Link
                                                    ...
                                                    className={`flex flex-row items-center justify-center lg:justify-start gap-4 text-gray-500 dark:text-gray-200 py-2 md:px-2 rounded-[6px] hover:bg-[#51DFC3] dark:hover:bg-gray-700 ${path === item.href.split('/').at(-1) && 'bg-[#51DFC3] dark:bg-gray-700'}`}
                                                >
