    ...
    return (
        <div className="flex items-center justify-between bg-white dark:bg-slate-900 p-4 shadow-md">
            ...
            <div className="realtive w-full flex items-center justify-end gap-4 pr-4">
                ...
                {
                    showPopup === 'message' &&
                    <div className="absolute max-w-[200px] max-h-[300px] overflow-y-auto w-full top-14 right-14 text-xs text-gray-900 dark:text-gray-200 rounded-[6px] bg-white shadow-md dark:bg-slate-900 flex flex-col gap-1 z-30 border border-gray-400 dark:border-gray-200">
                ...
                {/* Announcement Popup */}
                {
                    ...
                    <div className="absolute max-w-[200px] max-h-[300px] overflow-y-auto w-full top-14 right-10 text-xs text-gray-900 dark:text-gray-200 rounded-[6px] bg-white shadow-md dark:bg-slate-900 flex flex-col gap-1 z-30 border border-gray-400 dark:border-gray-200">
                        <div className="flex gap-2 items-center justify-between px-2 pt-2">
