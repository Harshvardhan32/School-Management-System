    ...
    return (
        <div className="rounded-[6px] odd:bg-[#51DFC3] even:bg-[#FF5B76] p-4 flex-1 min-w-[130px] shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
            <div className="relative flex justify-between items-center">
                ...
                {
                    dropdown &&
                    <Link to={href} className="absolute -right-4 top-6 bg-white dark:bg-slate-900 dark:text-gray-200 border border-gray-400 text-gray-800 text-sm rounded-[6px] p-1">View All</Link>
                }
            </div>
