    ...
    const renderRow = (item) => {
        return (
            <tr key={item.id} className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-purple-50">
                ...
                <td className="hidden md:table-cell p-4">{item.student}</td>
                <td className="hidden md:table-cell p-4">{item.date}</td>
                <td className="hidden sm:table-cell p-4">{item.type}</td>
                <td className="hidden sm:table-cell p-4">{item.score}</td>
                <td className="p-4">
